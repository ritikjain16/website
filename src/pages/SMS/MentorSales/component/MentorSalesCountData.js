...
class MentorSalesCountData extends Component {
  ...
  countData.groupByData.map(status => {
    ...
    const total = countData && countData.count ? countData.count - (data.unfit ? data.unfit : 0) : 0
    // console.log(data)
    // if (countData.data === {}) {
    //   return null
    // }
    return (
      <MentorSalesStyle.MentorSalesCountData>
        <MentorSalesStyle.FilterCheckBox onChange={this.onChange} value='unfit'>
        ...
        <MentorSalesStyle.FilterCheckBox onChange={this.onChange} value='pipeline'>
        ...
        <MentorSalesStyle.FilterCheckBox onChange={this.onChange} value='hot'>
        ...
        <MentorSalesStyle.FilterCheckBox onChange={this.onChange} value='won'>
          <MentorSalesStyle.FilterBox style={{ backgroundColor: '#6db921' }}>
            <span>Won</span>
            <span>{data && data.won ? data.won : '-'} deals</span>
            <MentorSalesStyle.SalesPercentage>
              {data && data.won ? Math.floor((data.won / total) * 100) : '-'}%
            </MentorSalesStyle.SalesPercentage>
          </MentorSalesStyle.FilterBox>
        </MentorSalesStyle.FilterCheckBox>
        <MentorSalesStyle.FilterCheckBox onChange={this.onChange} value='lost'>
        ...
        <MentorSalesStyle.FilterCheckBox onChange={this.onChange} value='cold'>
