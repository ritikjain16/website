    ...
    >
      ...
      >
        ...
        <Link
          ...
          to={`/sms/assignTimetable/${this.props.batches.code}`}
        >
          <Tooltip
            placement='top'
        ...
        <Link
          rel='noopener noreferrer'
          to={`/sms/batchAttendance/${this.props.batches.code}`}
        >
          <Tooltip
            placement='top'
    ...
    return students.map((studentInfo, index) => (
      <>
        ...
        >
          ...
          <Table.Item style={{ fontSize: 14, background: '#ebebeb' }}>
            {!this.renderParentData(studentInfo) ? '-' : this.renderParentData(studentInfo).phone && this.renderParentData(studentInfo).phone.number}
          </Table.Item>
          <Table.Item style={{ fontSize: 14, background: '#ebebeb' }}>
