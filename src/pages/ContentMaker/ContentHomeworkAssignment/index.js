...
const ContentHomeworkAssignment = withNav(ContentAssignment)({
  title: 'Homework Assignments',
  activeNavItem: 'Homework Assignments',
...
const ContentHomeworkAssignmentWithExtraProps = injectProps({
  notification,
})(ContentHomeworkAssignment)

export default connect(mapStateToProps)(withRouter(ContentHomeworkAssignmentWithExtraProps))
