...
import updateUserCurrentTopicComponentStatus from '../../../actions/mentorConversion/updateUserCurrentTopicStatus'
  ...
  render() {
    ...
    return (
        ...
        <Col span={12} style={{
          ...
          padding: '5px 0',
          paddingLeft: 10,
        }}>{get(student, 'currentTopicStatus[0].currentTopic.order')}. {get(student, 'currentTopicStatus[0].currentTopic.title')}</Col>
        </Row>
        <Row>
        <Col span={8} style={{
          padding: '5px 0',
